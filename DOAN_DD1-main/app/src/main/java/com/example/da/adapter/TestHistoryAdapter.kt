...
class TestHistoryAdapter(
    ...
    private val onViewAnswers: (Int) -> Unit
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TestHistoryViewHolder {
        ...
        return TestHistoryViewHolder(view, onViewAnswers)
    }
    ...
    class TestHistoryViewHolder(itemView: View, private val onViewAnswers: (Int) -> Unit) : RecyclerView.ViewHolder(itemView) {
        private val tvScore: TextView = itemView.findViewById(R.id.tvScore)
        private val tvTimeTaken: TextView = itemView.findViewById(R.id.tvTimeTaken)
        private val tvDate: TextView = itemView.findViewById(R.id.tvDate)
        private val btnViewAnswers: Button = itemView.findViewById(R.id.btnViewAnswers)
